...
// Archivo: GeminiService.java (Método: obtenerHistorialConversacion)
        ...
        private String obtenerHistorialConversacion(Integer userId) {
            ...
            // PROBLEMA: historial.reversed() no funciona en Java < 21.
            // SOLUCIÓN: Usamos Collections.reverse() para invertir la lista.
            Collections.reverse(historial); // <-- CAMBIO CLAVE

            // Ahora, 'historial' ya está en orden cronológico.
